...
local resourceName = 'HUD'           -- The name of your FiveM resource
...
local githubVersionFilename = 'hud-version.txt'     -- The filename on GitHub containing the version information
